...
SELECT COUNT(full_name) AS team_number
FROM teams;

-- 2. How many players?
SELECT COUNT(full_name) AS player_count
FROM players;

-- 3. What is the earliest founding year of any team?
SELECT min(year_founded) AS earliest_founding_year
FROM teams;

-- 4. What is the most recent?
SELECT max(year_founded) AS earliest_founding_year
FROM teams;

-- 5. What is the average founding year, rounded to a whole number?
SELECT avg(year_founded) AS earliest_founding_year
FROM teams;
...
--Any non-null (COMPLETELY empty, "" counts as non-null) value

-- =====================================================================
-- VOCABULARY — your words, not the reference sheet's
-- =====================================================================

-- Aggregate function: Gets one value from a math function that includes every value (sum, average, max, min, etc)
